...
// loop through urls
// :( dammit it's only the argument URL we want to test.)
// FOR NOW, the URL is the third arg.
...
request(url, (err, res, body) => {
    ...
    // fix this: 
    const onloadTimestamp = new Date();
    ...
    // here the yslow object should be set.
    ...
    yscontext.PAGE.t_done = new Date();
